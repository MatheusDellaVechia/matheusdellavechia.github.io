// Configuração central do site. Ajuste conforme necessário.
...
export const SOCIALS = {
  github: 'https://github.com/MatheusDellaVechia',
  linkedin: 'https://www.linkedin.com/in/matheus-h-della-vechia/',
};
